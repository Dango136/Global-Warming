# Global-Warming
This TG Bot will explain what is Global Warming and what we can do to slow it down or even prevent it!
## Technologies:
+ Python
+ TeleBot library
## Functionality:
1. The bot must tell the user about Global Warning, what is causing it and how we can slow it.
